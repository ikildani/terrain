...
function ActivityContent() {
      ...
      <>
        ...
        <div className="card noise p-12 flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <p className="text-sm text-slate-400 leading-relaxed mb-6">
            This feature requires a Team or Enterprise plan. Shared workspaces include activity feeds, collaboration,
            and audit trails.
          </p>
  ...
  return (
    <>
      <PageHeader title="Activity" subtitle={activeWorkspace.name} badge={planBadge} />
