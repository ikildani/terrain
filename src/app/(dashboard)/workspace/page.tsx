...
function WorkspaceContent() {
  ...
  // ── Has workspace plan but no workspace created yet ───
    ...
    return (
      <>
        ...
        <div className="card noise p-12 flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <p className="text-sm text-slate-400 leading-relaxed mb-6">
            Your workspace is where your team collaborates on reports, shares analyses, and tracks activity.
          </p>
  ...
  // ── Workspace exists ────────────────────────────────────
  const planBadge = activeWorkspace.plan === 'enterprise' ? 'Enterprise' : 'Team';
  return (
    <>
      <PageHeader title="Workspace" subtitle={activeWorkspace.name} badge={planBadge} />
