...
const THERAPY_AREA_KEYWORDS: Record<string, string[]> = {
  ...
  // Canonical alias — pulmonology maps to same partner pool as respiratory
  pulmonology: [
    'asthma',
    'copd',
    'ipf',
  ...
  // Canonical alias — hepatology maps to same partner pool as liver_disease
  hepatology: [
    'liver',
    'hepatic',
    'cirrhosis',
  ...
  // Canonical alias — neurology maps to same partner pool as neuroscience
  neurology: [
    'alzheimer',
    'parkinson',
    'epilepsy',
  ...
  // ── Cross-cutting modality (not a canonical TA) ──
  gene_therapy: [
    'gene therapy',
    'aav',
    'lentiviral',
...
> = {
  ...
  neuroscience: {
    // Alias for partner DB compatibility
    preclinical: { avg_upfront_m: 15, avg_total_m: 250, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 40, avg_total_m: 500, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 100, avg_total_m: 1000, royalty: '8-15% tiered' },
    phase3: { avg_upfront_m: 300, avg_total_m: 2500, royalty: '12-22% tiered' },
  ...
  cardiovascular: {
    preclinical: { avg_upfront_m: 20, avg_total_m: 350, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 50, avg_total_m: 650, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 150, avg_total_m: 1500, royalty: '10-16% tiered' },
    phase3: { avg_upfront_m: 400, avg_total_m: 3000, royalty: '14-22% tiered' },
    approved: { avg_upfront_m: 900, avg_total_m: 5500, royalty: '20-30% tiered' },
  },
  metabolic: {
    // GLP-1/SGLT2 premium valuations
    preclinical: { avg_upfront_m: 25, avg_total_m: 400, royalty: '3-6% tiered' },
    phase1: { avg_upfront_m: 60, avg_total_m: 800, royalty: '6-12% tiered' },
    phase2: { avg_upfront_m: 200, avg_total_m: 2000, royalty: '12-20% tiered' },
    phase3: { avg_upfront_m: 500, avg_total_m: 4000, royalty: '18-28% tiered' },
    approved: { avg_upfront_m: 1200, avg_total_m: 7000, royalty: '22-32% tiered' },
  },
  psychiatry: {
    // High failure rate depresses valuations
    preclinical: { avg_upfront_m: 10, avg_total_m: 150, royalty: '2-4% tiered' },
    phase1: { avg_upfront_m: 25, avg_total_m: 300, royalty: '4-8% tiered' },
    phase2: { avg_upfront_m: 75, avg_total_m: 700, royalty: '8-14% tiered' },
    phase3: { avg_upfront_m: 200, avg_total_m: 1800, royalty: '12-20% tiered' },
    approved: { avg_upfront_m: 500, avg_total_m: 3000, royalty: '18-25% tiered' },
  },
  pain_management: {
    // CGRP class revived deal activity
    preclinical: { avg_upfront_m: 10, avg_total_m: 150, royalty: '2-4% tiered' },
    phase1: { avg_upfront_m: 30, avg_total_m: 350, royalty: '4-8% tiered' },
    phase2: { avg_upfront_m: 80, avg_total_m: 800, royalty: '8-14% tiered' },
    phase3: { avg_upfront_m: 200, avg_total_m: 1800, royalty: '12-20% tiered' },
    approved: { avg_upfront_m: 500, avg_total_m: 3500, royalty: '18-26% tiered' },
  },
  infectious_disease: {
    // Vaccine/antiviral premiums
    preclinical: { avg_upfront_m: 15, avg_total_m: 200, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 40, avg_total_m: 500, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 120, avg_total_m: 1200, royalty: '8-15% tiered' },
    phase3: { avg_upfront_m: 300, avg_total_m: 2500, royalty: '12-22% tiered' },
    approved: { avg_upfront_m: 700, avg_total_m: 4500, royalty: '18-28% tiered' },
  },
  hematology: {
    // Gene therapy premiums for SCD/hemophilia
    preclinical: { avg_upfront_m: 20, avg_total_m: 300, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 50, avg_total_m: 600, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 150, avg_total_m: 1500, royalty: '10-18% tiered' },
    phase3: { avg_upfront_m: 400, avg_total_m: 3000, royalty: '15-25% tiered' },
    approved: { avg_upfront_m: 900, avg_total_m: 5500, royalty: '22-32% tiered' },
  },
  ophthalmology: {
    // Anti-VEGF/gene therapy valuations
    preclinical: { avg_upfront_m: 15, avg_total_m: 200, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 40, avg_total_m: 500, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 120, avg_total_m: 1200, royalty: '8-15% tiered' },
    phase3: { avg_upfront_m: 300, avg_total_m: 2500, royalty: '14-22% tiered' },
    approved: { avg_upfront_m: 700, avg_total_m: 4000, royalty: '18-28% tiered' },
  },
  pulmonology: {
    preclinical: { avg_upfront_m: 15, avg_total_m: 250, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 40, avg_total_m: 500, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 125, avg_total_m: 1200, royalty: '10-16% tiered' },
    phase3: { avg_upfront_m: 300, avg_total_m: 2500, royalty: '14-22% tiered' },
    approved: { avg_upfront_m: 700, avg_total_m: 4000, royalty: '18-28% tiered' },
  },
  respiratory: {
  ...
  nephrology: {
    // Emerging novel agent valuations
    preclinical: { avg_upfront_m: 15, avg_total_m: 200, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 35, avg_total_m: 450, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 100, avg_total_m: 1000, royalty: '8-15% tiered' },
    phase3: { avg_upfront_m: 250, avg_total_m: 2000, royalty: '12-20% tiered' },
    approved: { avg_upfront_m: 600, avg_total_m: 3500, royalty: '18-26% tiered' },
  },
  dermatology: {
    // IL-17/IL-23 biologic deal structures
    preclinical: { avg_upfront_m: 20, avg_total_m: 300, royalty: '3-6% tiered' },
    phase1: { avg_upfront_m: 50, avg_total_m: 600, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 150, avg_total_m: 1500, royalty: '10-18% tiered' },
  ...
  gastroenterology: {
    // IBD biologic deal structures
    preclinical: { avg_upfront_m: 18, avg_total_m: 280, royalty: '3-6% tiered' },
    phase1: { avg_upfront_m: 45, avg_total_m: 550, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 140, avg_total_m: 1400, royalty: '10-16% tiered' },
    phase3: { avg_upfront_m: 350, avg_total_m: 2800, royalty: '14-22% tiered' },
    approved: { avg_upfront_m: 800, avg_total_m: 5000, royalty: '20-30% tiered' },
  },
  hepatology: {
    // NASH/HCV deal structures
    preclinical: { avg_upfront_m: 15, avg_total_m: 250, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 40, avg_total_m: 500, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 120, avg_total_m: 1200, royalty: '8-15% tiered' },
    phase3: { avg_upfront_m: 300, avg_total_m: 2500, royalty: '14-22% tiered' },
  ...
  endocrinology: {
    // GLP-1/thyroid/GH deal structures
    preclinical: { avg_upfront_m: 15, avg_total_m: 250, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 40, avg_total_m: 500, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 120, avg_total_m: 1200, royalty: '10-16% tiered' },
    phase3: { avg_upfront_m: 300, avg_total_m: 2500, royalty: '14-22% tiered' },
    approved: { avg_upfront_m: 700, avg_total_m: 4000, royalty: '18-28% tiered' },
  },
  musculoskeletal: {
    // Anti-TNF/biosimilar-era deal structures
    preclinical: { avg_upfront_m: 15, avg_total_m: 200, royalty: '2-5% tiered' },
    phase1: { avg_upfront_m: 35, avg_total_m: 400, royalty: '5-10% tiered' },
    phase2: { avg_upfront_m: 100, avg_total_m: 1000, royalty: '8-15% tiered' },
    phase3: { avg_upfront_m: 250, avg_total_m: 2000, royalty: '12-20% tiered' },
    approved: { avg_upfront_m: 600, avg_total_m: 3500, royalty: '18-26% tiered' },
  },
...
const DEAL_FAILURE_RATES: Record<string, Record<string, number>> = {
  ...
  neuroscience: { preclinical: 0.4, phase1: 0.32, phase2: 0.25, phase3: 0.15, approved: 0.06 },
  cardiovascular: { preclinical: 0.38, phase1: 0.3, phase2: 0.22, phase3: 0.12, approved: 0.05 },
  metabolic: { preclinical: 0.32, phase1: 0.25, phase2: 0.18, phase3: 0.1, approved: 0.04 },
  psychiatry: { preclinical: 0.45, phase1: 0.38, phase2: 0.3, phase3: 0.18, approved: 0.07 }, // Highest failure — placebo response
  pain_management: { preclinical: 0.42, phase1: 0.35, phase2: 0.28, phase3: 0.15, approved: 0.06 }, // Abuse liability risk
  infectious_disease: { preclinical: 0.3, phase1: 0.22, phase2: 0.15, phase3: 0.08, approved: 0.03 },
  hematology: { preclinical: 0.3, phase1: 0.22, phase2: 0.15, phase3: 0.08, approved: 0.03 },
  ophthalmology: { preclinical: 0.32, phase1: 0.25, phase2: 0.18, phase3: 0.1, approved: 0.04 },
  pulmonology: { preclinical: 0.35, phase1: 0.28, phase2: 0.2, phase3: 0.12, approved: 0.05 },
  respiratory: { preclinical: 0.35, phase1: 0.28, phase2: 0.2, phase3: 0.12, approved: 0.05 },
  nephrology: { preclinical: 0.38, phase1: 0.3, phase2: 0.22, phase3: 0.12, approved: 0.05 },
  dermatology: { preclinical: 0.3, phase1: 0.22, phase2: 0.15, phase3: 0.08, approved: 0.03 },
  gastroenterology: { preclinical: 0.33, phase1: 0.25, phase2: 0.18, phase3: 0.1, approved: 0.04 },
  hepatology: { preclinical: 0.35, phase1: 0.28, phase2: 0.2, phase3: 0.12, approved: 0.05 },
  liver_disease: { preclinical: 0.35, phase1: 0.28, phase2: 0.2, phase3: 0.12, approved: 0.05 },
  endocrinology: { preclinical: 0.33, phase1: 0.25, phase2: 0.18, phase3: 0.1, approved: 0.04 },
  musculoskeletal: { preclinical: 0.35, phase1: 0.28, phase2: 0.2, phase3: 0.12, approved: 0.05 },
