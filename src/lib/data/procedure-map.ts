...
export const PROCEDURE_DATA: ProcedureData[] = [
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    synonyms: ['shoulder replacement', 'total shoulder', 'reverse shoulder', 'TSA', 'RSA'],
    cpt_codes: ['23472', '23473', '23474'],
    drg_codes: ['483', '484'],
    device_category: 'orthopedic',
    us_annual_procedures: 160000,
    us_procedure_growth_rate: 9.0,
    procedure_setting: ['hospital_inpatient', 'hospital_outpatient'],
    eligible_sites: { hospitals: 3500, ascs: 200, clinics: 0 },
    performing_specialty: ['Orthopedic Surgery'],
    adoption_barrier: 'low',
    procedure_source: 'AAOS National Shoulder Arthroplasty Registry 2024; CMS claims data',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 16000,
      medicare_physician_rate: 1800,
      private_payer_coverage: 'Universally covered. ASC migration accelerating for appropriate patients.',
    },
    major_device_competitors: [
      'INHANCE (Zimmer Biomet) — augmented reality guided',
      'BLUEPRINT (Wright Medical/Stryker) — 3D planning',
      'PERFORM Reversed (DJO/Enovis)',
      'Comprehensive (Biomet)',
    ],
    market_leader: 'Zimmer Biomet',
    market_leader_share_pct: 30,
    current_standard_of_care:
      'Reverse total shoulder replacement dominant for rotator cuff arthropathy and complex fractures',
    cagr_5yr: 9.0,
    growth_driver: 'Reverse shoulder indications expanding; aging population; ASC migration',
  },
  {
    name: 'ACL Reconstruction',
    synonyms: ['ACL repair', 'anterior cruciate ligament', 'ACL surgery', 'knee ligament reconstruction'],
    cpt_codes: ['29888', '29889'],
    drg_codes: ['503', '504'],
    device_category: 'orthopedic',
    us_annual_procedures: 200000,
    us_procedure_growth_rate: 3.0,
    procedure_setting: ['hospital_outpatient', 'asc'],
    eligible_sites: { hospitals: 4000, ascs: 3000, clinics: 0 },
    performing_specialty: ['Orthopedic Surgery', 'Sports Medicine'],
    adoption_barrier: 'low',
    procedure_source: 'AOSSM/MOON Group registry data; CMS claims 2024',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 8000,
      medicare_physician_rate: 1200,
      private_payer_coverage: 'Universally covered. ASC-dominant procedure.',
    },
    major_device_competitors: [
      'Arthrex — BTB/hamstring fixation systems',
      'Smith+Nephew — ENDOBUTTON',
      'Stryker — CrossFix',
      'Zimmer Biomet — ToggleLoc',
    ],
    market_leader: 'Arthrex',
    market_leader_share_pct: 40,
    current_standard_of_care: 'Arthroscopic hamstring or BTB autograft reconstruction',
    cagr_5yr: 3.0,
    growth_driver: 'Youth sports participation; ACL bridge-enhanced repair emerging; internal brace augmentation',
  },
  {
    name: 'Rotator Cuff Repair',
    synonyms: ['shoulder arthroscopy repair', 'RCR', 'rotator cuff surgery'],
    cpt_codes: ['29827', '29828'],
    drg_codes: ['507', '508'],
    device_category: 'orthopedic',
    us_annual_procedures: 460000,
    us_procedure_growth_rate: 4.0,
    procedure_setting: ['hospital_outpatient', 'asc'],
    eligible_sites: { hospitals: 4500, ascs: 3500, clinics: 0 },
    performing_specialty: ['Orthopedic Surgery', 'Sports Medicine'],
    adoption_barrier: 'low',
    procedure_source: 'AAOS Registry; CMS claims data 2024',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 7500,
      medicare_physician_rate: 1100,
      private_payer_coverage: 'Universally covered.',
    },
    major_device_competitors: [
      'Arthrex — SpeedBridge knotless',
      'Smith+Nephew — HEALICOIL anchors',
      'Stryker — IconixII',
      'Zimmer Biomet — JuggerKnot',
    ],
    market_leader: 'Arthrex',
    market_leader_share_pct: 45,
    current_standard_of_care: 'Arthroscopic double-row repair with suture anchors',
    cagr_5yr: 4.0,
    growth_driver:
      'Aging active population; superior capsular reconstruction for irreparable tears; biologic augmentation patches',
  },

  // ──────────────────────────────────────────────────────────
  // ADDITIONAL GI / ENDOSCOPY PROCEDURES
  // ──────────────────────────────────────────────────────────
  {
    name: 'Colonoscopy',
    synonyms: ['screening colonoscopy', 'diagnostic colonoscopy', 'colon cancer screening'],
    cpt_codes: ['45378', '45380', '45384', '45385'],
    drg_codes: [],
    device_category: 'endoscopy_gi',
    us_annual_procedures: 19000000,
    us_procedure_growth_rate: 3.5,
    procedure_setting: ['hospital_outpatient', 'asc'],
    eligible_sites: { hospitals: 5500, ascs: 5000, clinics: 0 },
    performing_specialty: ['Gastroenterology', 'General Surgery'],
    adoption_barrier: 'low',
    procedure_source: 'AGA Clinical Practice Update 2024; CMS Medicare Part B data',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 1200,
      medicare_physician_rate: 350,
      private_payer_coverage:
        'Preventive screening covered at 100% under ACA. Diagnostic colonoscopy subject to deductible/copay.',
    },
    major_device_competitors: [
      'Olympus — EVIS X1 system',
      'Fujifilm — ELUXEO 8000',
      'Pentax Medical — i20c',
      'Medtronic — GI Genius AI polyp detection',
    ],
    market_leader: 'Olympus',
    market_leader_share_pct: 65,
    current_standard_of_care: 'Standard white-light colonoscopy with AI-aided polyp detection emerging',
    cagr_5yr: 3.5,
    growth_driver: 'CRC screening age lowered to 45; AI-assisted detection; 45-49 cohort newly eligible',
  },
  {
    name: 'Upper GI Endoscopy (EGD)',
    synonyms: ['esophagogastroduodenoscopy', 'upper endoscopy', 'EGD', 'gastroscopy'],
    cpt_codes: ['43235', '43239', '43249'],
    drg_codes: [],
    device_category: 'endoscopy_gi',
    us_annual_procedures: 7000000,
    us_procedure_growth_rate: 2.5,
    procedure_setting: ['hospital_outpatient', 'asc'],
    eligible_sites: { hospitals: 5500, ascs: 4000, clinics: 0 },
    performing_specialty: ['Gastroenterology'],
    adoption_barrier: 'low',
    procedure_source: 'AGA data; CMS claims 2024',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 900,
      medicare_physician_rate: 280,
      private_payer_coverage: 'Covered for diagnostic indications. BE screening under review.',
    },
    major_device_competitors: ['Olympus — GIF-XZ1200 (4K)', 'Fujifilm — EG-820LR', 'Pentax — EG29-i10c2'],
    market_leader: 'Olympus',
    market_leader_share_pct: 70,
    current_standard_of_care: 'High-definition white-light endoscopy with narrow-band imaging',
    cagr_5yr: 2.5,
    growth_driver: 'Barrett esophagus screening expansion; endoscopic resection replacing surgery for early GI cancers',
  },
  {
    name: 'Bariatric Surgery',
    synonyms: ['weight loss surgery', 'gastric bypass', 'sleeve gastrectomy', 'metabolic surgery'],
    cpt_codes: ['43775', '43644', '43645', '43659'],
    drg_codes: ['619', '620', '621'],
    device_category: 'endoscopy_gi',
    us_annual_procedures: 280000,
    us_procedure_growth_rate: -5.0,
    procedure_setting: ['hospital_inpatient'],
    eligible_sites: { hospitals: 900, ascs: 50, clinics: 0 },
    performing_specialty: ['Bariatric Surgery', 'General Surgery'],
    adoption_barrier: 'moderate',
    procedure_source: 'ASMBS 2024 data; MBSAQIP registry',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 25000,
      medicare_physician_rate: 2200,
      private_payer_coverage:
        'Covered with BMI >= 40 or >= 35 + comorbidities. 3-6 month supervised weight management often required.',
    },
    major_device_competitors: [
      'Medtronic — Hugo (robotic-assisted)',
      'Intuitive — da Vinci (robotic sleeve)',
      'Ethicon (J&J) — stapling/energy',
      'Applied Medical — GelPOINT access',
    ],
    market_leader: 'Intuitive Surgical (robotic assist)',
    market_leader_share_pct: 30,
    current_standard_of_care: 'Laparoscopic sleeve gastrectomy (80% of bariatric cases)',
    cagr_5yr: -5.0,
    growth_driver:
      'DECLINING due to GLP-1 agonists (Wegovy/Zepbound). Volume dropped ~15% in 2024-2025. Endoscopic alternatives emerging.',
  },

  // ──────────────────────────────────────────────────────────
  // ADDITIONAL ENT PROCEDURES
  // ──────────────────────────────────────────────────────────
  {
    name: 'Cochlear Implantation',
    synonyms: ['cochlear implant surgery', 'CI surgery'],
    cpt_codes: ['69930'],
    drg_codes: ['129', '130'],
    device_category: 'ent',
    us_annual_procedures: 70000,
    us_procedure_growth_rate: 8.0,
    procedure_setting: ['hospital_inpatient', 'hospital_outpatient'],
    eligible_sites: { hospitals: 500, ascs: 50, clinics: 0 },
    performing_specialty: ['Otolaryngology', 'Neurotology'],
    adoption_barrier: 'moderate',
    procedure_source: 'Cochlear Ltd investor data; ASHA registry estimates',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 28000,
      medicare_physician_rate: 2500,
      private_payer_coverage:
        'Covered for severe-to-profound SNHL. Prior authorization required. Bilateral coverage expanding.',
    },
    major_device_competitors: ['Cochlear — Nucleus 8', 'MED-EL — SYNCHRONY 2', 'Advanced Bionics (Sonova) — Marvel CI'],
    market_leader: 'Cochlear Limited',
    market_leader_share_pct: 60,
    current_standard_of_care:
      'Unilateral CI standard; bilateral implantation growing; candidacy criteria expanding to include moderate hearing loss',
    cagr_5yr: 8.0,
    growth_driver:
      'Expanded candidacy (single-sided deafness, moderate loss); OTC hearing aid awareness driving CI awareness; bilateral coverage',
  },
  {
    name: 'Tonsillectomy',
    synonyms: ['tonsil removal', 'adenotonsillectomy'],
    cpt_codes: ['42826', '42825', '42820'],
    drg_codes: ['58', '59'],
    device_category: 'ent',
    us_annual_procedures: 500000,
    us_procedure_growth_rate: -1.0,
    procedure_setting: ['hospital_outpatient', 'asc'],
    eligible_sites: { hospitals: 4000, ascs: 2000, clinics: 0 },
    performing_specialty: ['Otolaryngology'],
    adoption_barrier: 'low',
    procedure_source: 'AAO-HNS Clinical Practice Guideline 2024; HCUP data',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 4000,
      medicare_physician_rate: 600,
      private_payer_coverage:
        'Universally covered for appropriate indications (recurrent tonsillitis, OSA in children).',
    },
    major_device_competitors: [
      'Medtronic — Coblation (plasma technology)',
      'Stryker — Hummingbird (powered)',
      'Olympus — Thunderbeat',
      'Integra — CUSA',
    ],
    market_leader: 'Medtronic (Coblation)',
    market_leader_share_pct: 35,
    current_standard_of_care:
      'Cold steel or Coblation tonsillectomy; intracapsular (partial) tonsillectomy growing for pediatric OSA',
    cagr_5yr: -1.0,
    growth_driver: 'Slight decline as more conservative management of tonsillitis; partial tonsillectomy gaining share',
  },
  ...
  // ──────────────────────────────────────────────────────────
  {
    name: 'Robot-Assisted Prostatectomy',
    synonyms: ['RARP', 'robotic prostatectomy', 'radical prostatectomy'],
    cpt_codes: ['55866'],
    drg_codes: ['714', '715'],
    device_category: 'urology',
    us_annual_procedures: 85000,
    us_procedure_growth_rate: 3.0,
    procedure_setting: ['hospital_inpatient'],
    eligible_sites: { hospitals: 2500, ascs: 0, clinics: 0 },
    performing_specialty: ['Urology'],
    adoption_barrier: 'moderate',
    procedure_source: 'AUA Quality Registry; CMS data 2024',
    reimbursement: {
      cms_coverage: 'covered',
      medicare_facility_rate: 18000,
      medicare_physician_rate: 2200,
      private_payer_coverage: 'Covered. Robotic approach dominant (>85% of prostatectomies).',
    },
    major_device_competitors: ['Intuitive — da Vinci Xi/5', 'Medtronic — Hugo RAS', 'CMR — Versius'],
    market_leader: 'Intuitive Surgical',
    market_leader_share_pct: 90,
    current_standard_of_care:
      'Robot-assisted radical prostatectomy (RARP) is SOC for surgical treatment of localized prostate cancer',
    cagr_5yr: 3.0,
    growth_driver:
      'Active surveillance shift reducing volumes; focal therapy competition; new robotic systems providing price competition',
  },
];
