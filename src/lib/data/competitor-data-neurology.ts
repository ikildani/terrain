...
export const NEUROLOGY_COMPETITORS: CompetitorRecord[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of ALS to slow functional decline; combination of sodium phenylbutyrate and taurursodiol targeting ER stress and mitochondrial dysfunction (voluntarily withdrawn from market 2024 after PHOENIX Phase 3 trial failure)',
    mechanism:
      'Dual mechanism combining ER stress inhibitor (sodium phenylbutyrate) and mitochondrial modulator (taurursodiol) to reduce neuronal death',
    ...
    key_data:
      'CENTAUR trial (NCT03127514): -2.32 point difference in ALSFRS-R decline vs placebo over 24 weeks (p=0.03); n=137. PHOENIX Phase 3 confirmatory trial failed primary endpoint, leading to voluntary US market withdrawal in April 2024.',
  ...
  },
  {
    ...
    indication: 'Amyotrophic Lateral Sclerosis',
    indication_specifics:
      'Treatment of ALS in adults with SOD1 mutation; antisense oligonucleotide targeting superoxide dismutase 1 mRNA',
    mechanism:
      'Antisense oligonucleotide (ASO) that binds to SOD1 mRNA, promoting RNase H-mediated degradation and reducing toxic SOD1 protein production',
    mechanism_category: 'antisense_oligonucleotide',
    molecular_target: 'SOD1 mRNA',
    phase: 'Approved',
    primary_endpoint:
      'Neurofilament light chain (NfL) plasma concentration change from baseline (surrogate endpoint for accelerated approval)',
    key_data:
      'VALOR trial (NCT02623699): Did not meet primary clinical endpoint (ALSFRS-R) but showed 60% reduction in plasma NfL; n=108. Granted accelerated approval based on NfL reduction as reasonably likely surrogate. Open-label extension showed sustained NfL reduction.',
  ...
  },
  {
    ...
    indication: 'Amyotrophic Lateral Sclerosis',
    indication_specifics:
      'Treatment of ALS as a free radical scavenger to reduce oxidative stress-mediated neuronal damage',
    mechanism:
      'Free radical scavenger that eliminates lipid peroxides and hydroxyl radicals, reducing oxidative stress-induced motor neuron damage',
    ...
    key_data:
      'Japanese Phase 3 (Study 19): 33% less decline in ALSFRS-R vs placebo over 24 weeks (p=0.001); n=137. Oral suspension (Radicava ORS) approved 2022 improving convenience over IV formulation.',
    line_of_therapy: 'Add-on therapy',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Anti-tau monoclonal antibody targeting extracellular tau aggregates in progressive supranuclear palsy',
    mechanism:
      'Humanized IgG4 monoclonal antibody that binds the N-terminal region of extracellular tau, preventing cell-to-cell spread of tau pathology',
    ...
    key_data:
      'PASSPORT Phase 2 trial (NCT04658472): Ongoing evaluation in PSP-Richardson syndrome. Earlier Phase 2 study in PSP showed dose-dependent reduction in free tau in CSF but did not meet primary clinical endpoint.',
  ...
  },
  {
    ...
    mechanism:
      'Humanized monoclonal antibody that targets N3pE (pyroglutamate) tau aggregates and promotes their clearance via microglial phagocytosis',
    mechanism_category: 'anti_tau_antibody',
    molecular_target: 'N3pE tau aggregates',
    phase: 'Phase 2',
    primary_endpoint: 'PSP Rating Scale (PSPRS) total score change from baseline',
    key_data:
      'Phase 2 study in PSP (NCT04185415): Evaluated multiple dose levels. Tau PET imaging substudies included to assess target engagement. Results pending full publication.',
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Progressive Supranuclear Palsy',
    indication_specifics:
      'Anti-tau antibody targeting the central domain of tau protein to prevent aggregation and spreading',
    mechanism:
      'Humanized IgG4 monoclonal antibody binding the central region (mid-domain) of tau protein, inhibiting tau seeding and fibril formation',
    mechanism_category: 'anti_tau_antibody',
    ...
    key_data:
      'Phase 1 study demonstrated favorable safety profile and dose-proportional pharmacokinetics. CSF biomarker analysis showed target engagement at higher doses. Advancing into PSP with biomarker-enriched design.',
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of generalized myasthenia gravis (gMG) in adults who are anti-AChR antibody positive via FcRn-mediated IgG reduction',
    mechanism:
      'Human IgG1 Fc fragment engineered to bind neonatal Fc receptor (FcRn) with high affinity, blocking IgG recycling and reducing pathogenic autoantibody levels',
    ...
    key_data:
      'ADAPT trial (NCT03669588): 67.7% MG-ADL responder rate vs 29.7% placebo (p<0.0001) in first cycle; n=167. Rapid onset (~1 week). ADAPT+ long-term extension showed durable response. SC formulation (Vyvgart Hytrulo) approved 2023.',
  ...
  },
  {
    ...
    indication: 'Myasthenia Gravis',
    indication_specifics:
      'Treatment of generalized myasthenia gravis in adults who are anti-AChR antibody positive via terminal complement inhibition',
    mechanism:
      'Long-acting humanized monoclonal antibody that binds complement component C5, preventing cleavage to C5a and C5b and blocking formation of the membrane attack complex (MAC)',
    ...
    key_data:
      'CHAMPION-MG trial (NCT03920293): Statistically significant improvement in MG-ADL (-3.1 vs -1.4 placebo; p<0.001) at 26 weeks; n=175. Every 8-week dosing offers convenience advantage over eculizumab.',
  ...
  },
  {
    ...
    indication: 'Myasthenia Gravis',
    indication_specifics:
      'Treatment of generalized myasthenia gravis via FcRn inhibition to reduce pathogenic IgG autoantibodies',
    mechanism:
      'Humanized monoclonal antibody targeting neonatal Fc receptor (FcRn), blocking IgG recycling and accelerating degradation of pathogenic autoantibodies',
    mechanism_category: 'fcrn_inhibitor',
    molecular_target: 'Neonatal Fc receptor (FcRn)',
    phase: 'Approved',
    primary_endpoint: 'MG-ADL total score change from baseline',
    key_data:
      'MycarinG Phase 3 trial (NCT03971422): Statistically significant improvement in MG-ADL score vs placebo at Day 43 in both AChR-Ab+ and MuSK-Ab+ patients; n=200. Subcutaneous administration.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of NMOSD in adults who are anti-AQP4 antibody positive via IL-6 receptor inhibition',
    mechanism:
      'Humanized recycling monoclonal antibody targeting interleukin-6 receptor (IL-6R), blocking IL-6 signaling that drives B cell activation, plasmablast survival, and autoantibody production',
    mechanism_category: 'il6_receptor_inhibitor',
    molecular_target: 'IL-6 receptor (IL-6R)',
    phase: 'Approved',
    primary_endpoint: 'Time to first relapse',
    key_data:
      'SAkuraSky (NCT02028884): 62% reduction in relapse risk vs placebo as add-on therapy (HR 0.38, p=0.02); n=83. SAkuraStar monotherapy: 55% relapse risk reduction (HR 0.45, p=0.06); n=95. Subcutaneous, self-administered every 4 weeks.',
  ...
  },
  {
    ...
    indication: 'Neuromyelitis Optica Spectrum Disorder',
    indication_specifics:
      'Treatment of NMOSD in adults who are anti-AQP4 antibody positive via terminal complement inhibition to prevent complement-mediated astrocyte damage',
    mechanism:
      'Humanized monoclonal antibody that binds complement component C5 with high affinity, preventing cleavage to C5a and C5b and blocking membrane attack complex formation on AQP4-expressing astrocytes',
    mechanism_category: 'complement_inhibitor',
    molecular_target: 'Complement C5',
    phase: 'Approved',
    primary_endpoint: 'Time to first adjudicated on-trial relapse',
    key_data:
      'PREVENT trial (NCT01892345): 94% reduction in relapse risk vs placebo (HR 0.06, p<0.001); n=143. 97.9% of eculizumab patients were relapse-free at 48 weeks. Dramatic efficacy but very high cost.',
  ...
  },
  {
    ...
    indication: 'Neuromyelitis Optica Spectrum Disorder',
    indication_specifics:
      'Treatment of NMOSD in adults who are anti-AQP4 antibody positive via B cell depletion targeting CD19',
    mechanism:
      'Humanized monoclonal antibody targeting CD19 on B cells, inducing antibody-dependent cellular cytotoxicity (ADCC) for broad B cell depletion including plasmablasts that produce AQP4-IgG',
    mechanism_category: 'anti_cd19_antibody',
    molecular_target: 'CD19',
    phase: 'Approved',
    primary_endpoint: 'Time to first adjudicated NMOSD attack',
    key_data:
      'N-MOmentum trial (NCT02200770): 73% reduction in NMOSD attacks vs placebo (HR 0.272, p<0.0001); n=230. Six-monthly IV infusion. Broader B cell depletion than anti-CD20 by targeting CD19+ plasmablasts.',
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    mechanism:
      'Polyclonal immunoglobulin preparation providing broad immunomodulation through Fc receptor saturation, complement scavenging, anti-idiotype antibody effects, and cytokine modulation',
    ...
    key_data:
      'ICE trial (Gamunex): 54% INCAT responder rate vs 21% placebo (p=0.0002); n=117 over 24 weeks. Multiple IVIG brands approved for CIDP. Cornerstone therapy for decades with extensive real-world evidence.',
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: false,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Chronic Inflammatory Demyelinating Polyneuropathy',
    indication_specifics:
      'Subcutaneous immunoglobulin with hyaluronidase for maintenance treatment of CIDP, enabling large-volume SC infusion',
    mechanism:
      'Subcutaneous immunoglobulin facilitated by recombinant human hyaluronidase (rHuPH20) which transiently increases SC tissue permeability, allowing large-volume immunoglobulin administration subcutaneously',
    mechanism_category: 'immunoglobulin_therapy',
    ...
    key_data:
      'ADVANCE-CIDP 3 trial (NCT02549170): Demonstrated non-inferiority to IVIG in preventing CIDP relapse; adjusted relapse rate 4.2% (Hyqvia) vs 5.2% (IVIG). Self-administered at home, reducing healthcare visits.',
  ...
  },
  {
    ...
    indication: 'Chronic Inflammatory Demyelinating Polyneuropathy',
    indication_specifics:
      'FcRn inhibitor under investigation for CIDP to reduce pathogenic IgG autoantibodies driving nerve demyelination',
    mechanism:
      'Human IgG1 Fc fragment that blocks neonatal Fc receptor (FcRn), accelerating degradation of IgG including pathogenic autoantibodies targeting peripheral nerve myelin',
    mechanism_category: 'fcrn_inhibitor',
    molecular_target: 'Neonatal Fc receptor (FcRn)',
    phase: 'Phase 3',
    primary_endpoint: 'CIDP relapse or INCAT score worsening during treatment withdrawal period',
    key_data:
      'ADHERE Phase 3 trial (NCT04281472): Evaluating efgartigimod SC (Vyvgart Hytrulo) in CIDP. Positive topline results reported with statistically significant reduction in relapse risk vs placebo. Potential to displace IVIG as standard of care. Phase 3 as of Jan 2025; verify current approval status.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of ATTR cardiomyopathy (wild-type and hereditary) by stabilizing transthyretin tetramers to prevent amyloid fibril formation',
    mechanism:
      'Small molecule TTR stabilizer that binds to the thyroxine-binding sites of the TTR tetramer, preventing dissociation into monomers that misfold and aggregate into amyloid fibrils',
    ...
    key_data:
      'ATTR-ACT trial (NCT01994889): 30% reduction in all-cause mortality (HR 0.70) and significant reduction in CV hospitalizations over 30 months; n=441. Now standard of care for ATTR-CM with >$4B annual revenue.',
    line_of_therapy: 'First-line',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  },
  {
    ...
    indication: 'Transthyretin Amyloid Cardiomyopathy',
    indication_specifics:
      'RNAi therapeutic silencing TTR gene expression to reduce amyloidogenic protein production in ATTR cardiomyopathy',
    mechanism:
      'Lipid nanoparticle-encapsulated small interfering RNA (siRNA) that targets TTR mRNA in hepatocytes, reducing TTR protein production by ~80% via RNA interference',
    mechanism_category: 'rna_interference',
    molecular_target: 'TTR mRNA',
    phase: 'Approved',
    primary_endpoint:
      'Change from baseline in 6-minute walk test distance and Kansas City Cardiomyopathy Questionnaire (KCCQ-OS)',
    key_data:
      'APOLLO-B trial (NCT03997383): Met primary endpoint with improvement in 6MWT and KCCQ-OS vs placebo at 12 months in ATTR-CM; n=360. Originally approved for ATTR polyneuropathy (APOLLO trial); cardiomyopathy indication expanded.',
    line_of_therapy: 'First-line or second-line',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Transthyretin Amyloid Cardiomyopathy',
    indication_specifics:
      'Ligand-conjugated antisense oligonucleotide targeting TTR mRNA to reduce circulating TTR protein in ATTR cardiomyopathy',
    mechanism:
      'GalNAc-conjugated antisense oligonucleotide (ASO) that binds TTR mRNA in hepatocytes and promotes RNase H-mediated degradation, reducing TTR protein production by ~80%',
    mechanism_category: 'antisense_oligonucleotide',
    molecular_target: 'TTR mRNA',
    phase: 'Approved',
    primary_endpoint: 'Change from baseline in modified Neuropathy Impairment Score +7 (mNIS+7) and Norfolk QoL-DN',
    key_data:
      'NEURO-TTRansform trial (NCT04136184): Superior to inotersen reference in polyneuropathy with ~80% TTR reduction; n=168. Monthly SC self-injection. CARDIO-TTRansform (NCT04136171) evaluating ATTR-CM indication ongoing.',
    line_of_therapy: 'First-line',
    partner: 'AstraZeneca',
    first_in_class: false,
    orphan_drug: true,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'First-line pharmacotherapy for essential tremor; non-selective beta-adrenergic receptor antagonist reducing tremor amplitude',
    mechanism:
      'Non-selective beta-adrenergic receptor antagonist that reduces tremor amplitude via peripheral beta-2 receptor blockade on skeletal muscle and central beta-1 receptor modulation',
    ...
    key_data:
      'Multiple controlled trials over 40+ years: Reduces tremor amplitude by ~50% in approximately 50-70% of patients. Extended-release formulation allows once-daily dosing. Gold standard first-line therapy.',
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: false,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Essential Tremor',
    indication_specifics:
      'Non-invasive wrist-worn neuromodulation device delivering transcutaneous afferent patterned stimulation (TAPS) to reduce hand tremor',
    mechanism:
      'Wrist-worn device delivering calibrated electrical stimulation to the median and radial nerves, disrupting the central tremor network via afferent nerve stimulation (TAPS therapy)',
    ...
    phase: 'Approved',
    primary_endpoint:
      'Tremor power reduction measured by on-device accelerometry; TETRAS (The Essential Tremor Rating Assessment Scale) upper limb score',
    key_data:
      'PROSPECT trial: 68% of patients experienced clinically meaningful tremor improvement; 49% median tremor power reduction during activities of daily living. FDA De Novo classification granted 2021.',
  ...
  },
  {
    ...
    indication: 'Essential Tremor',
    indication_specifics:
      'Selective T-type calcium channel blocker targeting thalamic oscillatory circuits underlying essential tremor',
    mechanism:
      'Selective Cav3.1/Cav3.2/Cav3.3 T-type calcium channel blocker that modulates thalamic oscillatory activity in the inferior olive-cerebellar-thalamic circuit responsible for tremor generation',
    mechanism_category: 't_type_calcium_channel_blocker',
    molecular_target: 'T-type calcium channels (Cav3.1, Cav3.2, Cav3.3)',
    phase: 'Phase 2',
    primary_endpoint:
      'TETRAS (The Essential Tremor Rating Assessment Scale) performance subscale upper limb score change from baseline',
    key_data:
      'T-CALM Phase 2 trial (NCT03101241): Mixed results in essential tremor with some evidence of dose-dependent tremor reduction. Development status uncertain following Jazz Pharmaceuticals acquisition of Cavion.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of cataplexy and excessive daytime sleepiness (EDS) in narcolepsy type 1 and type 2; lower-sodium oxybate formulation',
    mechanism:
      'Mixed-salt oxybate formulation that acts as a GABA-B receptor agonist and GHB receptor agonist, consolidating nighttime sleep architecture and reducing REM sleep intrusions',
    ...
    key_data:
      'Pivotal trial demonstrated non-inferiority to Xyrem (sodium oxybate) with 92% less sodium content. Phase 3 in idiopathic hypersomnia: significant ESS improvement (p<0.0001). ~$150,000/year US cost.',
  ...
  },
  {
    ...
    indication: 'Narcolepsy',
    indication_specifics:
      'Treatment of excessive daytime sleepiness in narcolepsy; first-in-class histamine H3 receptor inverse agonist/antagonist',
    mechanism:
      'Selective histamine H3 receptor inverse agonist/antagonist that blocks presynaptic autoreceptors, increasing histamine release in the tuberomammillary nucleus and enhancing wake-promoting neurotransmission',
    ...
    key_data:
      'HARMONY 1 (NCT01067222): ESS improvement of -3.0 vs placebo (p=0.024); n=94. HARMONY CTP: significant reduction in cataplexy (p=0.034). Once-daily oral dosing. Not a controlled substance.',
  ...
  },
  {
    ...
    indication: 'Narcolepsy',
    indication_specifics:
      'Oral orexin receptor 2 (OX2R) agonist for treatment of narcolepsy type 1; replaces deficient orexin signaling',
    mechanism:
      'Selective small molecule orexin receptor type 2 (OX2R) agonist that restores orexin signaling deficient in narcolepsy type 1, directly addressing the root pathophysiology of hypocretin neuron loss',
    mechanism_category: 'orexin_receptor_agonist',
    molecular_target: 'Orexin receptor type 2 (OX2R)',
    phase: 'Phase 3',
    primary_endpoint:
      'Maintenance of Wakefulness Test (MWT) mean sleep latency change from baseline; weekly cataplexy rate',
    key_data:
      'Phase 2 trial: Demonstrated dose-dependent improvement in MWT sleep latency and reduction in cataplexy frequency in NT1 patients. Moved to Phase 3 with multiple dose arms. Potential disease-modifying approach.',
    line_of_therapy: 'First-line',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of Rett syndrome in adults and pediatric patients aged 2+ years; synthetic analog of amino-terminal tripeptide of IGF-1',
    mechanism:
      'Synthetic analog of the amino-terminal tripeptide of insulin-like growth factor 1 (glycine-proline-glutamate, GPE) that modulates neuroinflammation, supports synaptic function, and normalizes glial cell activation in MECP2-deficient neurons',
    mechanism_category: 'igf1_analog',
    molecular_target: 'IGF-1 signaling pathway / neuroinflammatory pathways',
    phase: 'Approved',
    primary_endpoint:
      'Rett Syndrome Behaviour Questionnaire (RSBQ) total score and Clinical Global Impression-Improvement (CGI-I) at Week 12',
    key_data:
      'LAVENDER trial (NCT04181723): Statistically significant improvement in both co-primary endpoints vs placebo: RSBQ (p=0.0175) and CGI-I (p=0.0030); n=187. First and only FDA-approved treatment for Rett syndrome.',
    line_of_therapy: 'First-line',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Rett Syndrome',
    indication_specifics:
      'Sigma-1 receptor agonist under investigation for Rett syndrome to restore cellular homeostasis and synaptic plasticity',
    mechanism:
      'Sigma-1 receptor agonist and muscarinic receptor modulator that restores cellular proteostasis, enhances mitochondrial function, and modulates calcium signaling in MECP2-deficient neurons',
    ...
    key_data:
      'Phase 2/3 AVATAR trial (NCT03758924): Interim data showed improvement in RSBQ and CGI-I in pediatric Rett syndrome patients. Oral once-daily dosing. Pharmacogenomic biomarker (SIGMAR1 variants) explored for patient stratification.',
    line_of_therapy: 'First-line or adjunctive',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  },
  {
    ...
    indication: 'Rett Syndrome',
    indication_specifics:
      'AAV-based gene therapy delivering functional MECP2 gene with proprietary miRNA-Responsive Auto-Regulatory Element (miRARE) to treat the root cause of Rett syndrome',
    mechanism:
      'AAV9-based gene therapy delivering a functional copy of the MECP2 gene with a self-regulating expression cassette (miRARE) that uses endogenous miR-124 and miR-132 to auto-regulate MECP2 expression and prevent toxicity from overexpression',
    ...
    key_data:
      'Phase 1/2 trial (NCT05898620): First patients dosed in 2023. Self-regulating expression system designed to address the critical challenge of MECP2 overexpression toxicity. Intrathecal delivery route.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Antisense oligonucleotide targeting UBE3A-AS transcript to reactivate paternal UBE3A expression in Angelman syndrome neurons',
    mechanism:
      'Antisense oligonucleotide (ASO) that targets the UBE3A antisense transcript (UBE3A-ATS), which silences the paternal UBE3A allele in neurons. By degrading UBE3A-ATS, the ASO reactivates paternal UBE3A protein expression',
    mechanism_category: 'antisense_oligonucleotide',
    ...
    key_data:
      'Phase 1/2 KIK-AS trial (NCT04259281): Early data showed improvements in communication and motor function in some patients. Initial dosing pause due to lower extremity weakness (resolved); revised titration protocol implemented.',
  ...
  },
  {
    ...
    indication: 'Angelman Syndrome',
    indication_specifics:
      'Antisense oligonucleotide targeting UBE3A-AS to restore UBE3A expression from the intact paternal allele in Angelman syndrome',
    mechanism:
      'Antisense oligonucleotide (ASO) designed to selectively degrade the UBE3A antisense transcript in CNS neurons, de-repressing paternal UBE3A expression to restore functional UBE3A protein levels',
    mechanism_category: 'antisense_oligonucleotide',
    molecular_target: 'UBE3A antisense transcript (UBE3A-ATS)',
    phase: 'Phase 1/2',
    primary_endpoint: 'Safety and tolerability; developmental milestones and communication assessments',
    key_data:
      'Phase 1/2 trial (NCT05127226): Evaluating intrathecal ASO in children with Angelman syndrome. Ionis has extensive ASO platform experience from nusinersen (Spinraza) and tofersen (Qalsody). Multiple dose cohorts enrolling.',
    line_of_therapy: 'First-line (disease-modifying)',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  },
  {
    ...
    indication: 'Angelman Syndrome',
    indication_specifics:
      'Antisense oligonucleotide targeting UBE3A-ATS to restore paternal UBE3A expression in Angelman syndrome',
    mechanism:
      'Stereopure antisense oligonucleotide that selectively degrades the UBE3A antisense transcript, enabling transcription and translation of UBE3A protein from the intact but silenced paternal allele',
    mechanism_category: 'antisense_oligonucleotide',
    molecular_target: 'UBE3A antisense transcript (UBE3A-ATS)',
    phase: 'Phase 1',
    primary_endpoint: 'Safety, tolerability, pharmacokinetics, and preliminary efficacy measures',
    key_data:
      'Phase 1 MAGNOLIA trial (NCT05607680): First-in-human study evaluating intrathecal administration in children with Angelman syndrome. Stereopure chemistry from Wave Life Sciences collaboration may provide improved therapeutic index.',
    line_of_therapy: 'First-line (disease-modifying)',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Adjunctive treatment of seizures associated with Dravet syndrome in patients aged 1 year and older',
    mechanism:
      'Plant-derived cannabidiol (CBD) with multi-target anticonvulsant effects including GPR55 antagonism, TRPV1 desensitization, adenosine reuptake inhibition, and modulation of intracellular calcium via T-type calcium channels',
    ...
    key_data:
      'GWPCARE1 trial (NCT02091375): 39% median reduction in convulsive seizure frequency vs 13% placebo (p=0.01); n=120. GWPCARE2 confirmed: 42% reduction (20mg/kg/day) vs 17% placebo (p=0.002).',
  ...
  },
  {
    ...
    indication: 'Dravet Syndrome',
    indication_specifics:
      'Treatment of seizures associated with Dravet syndrome in patients aged 2 years and older; serotonergic anticonvulsant',
    mechanism:
      'Releases serotonin (5-HT) via SERT reversal and activates specific serotonin receptors (5-HT1D, 5-HT2A, 5-HT2C) and sigma-1 receptors to reduce seizure susceptibility in SCN1A-deficient neural circuits',
    ...
    key_data:
      'Study 1 (NCT02682927): 62.3% median reduction in convulsive seizure frequency (0.2 mg/kg/day) vs 17.4% placebo (p<0.001); n=119. Most effective adjunctive therapy for Dravet seizures. REMS required for cardiac monitoring.',
  ...
  },
  {
    ...
    indication: 'Dravet Syndrome',
    indication_specifics:
      'Cholesterol 24-hydroxylase (CH24H) inhibitor reducing brain cholesterol turnover to modulate NMDA receptor-mediated excitability in Dravet syndrome',
    mechanism:
      'First-in-class inhibitor of cholesterol 24-hydroxylase (CYP46A1/CH24H), which catalyzes brain cholesterol to 24(S)-hydroxycholesterol (24HC). 24HC is a positive allosteric modulator of NMDA receptors; reducing its levels decreases glutamatergic excitotoxicity',
    mechanism_category: 'cholesterol_24_hydroxylase_inhibitor',
    molecular_target: 'Cholesterol 24-hydroxylase (CYP46A1/CH24H)',
    phase: 'Phase 3',
    primary_endpoint: 'Percent change from baseline in convulsive seizure frequency per 28 days',
    key_data:
      'ENDYMION Phase 2 (NCT03635073): Open-label study showed 36% median reduction in convulsive seizure frequency. Phase 3 SKYLINE (NCT04940624) and STARGAZE trials ongoing in Dravet and Lennox-Gastaut syndromes.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Treatment of tardive dyskinesia in adults; selective vesicular monoamine transporter 2 (VMAT2) inhibitor',
    mechanism:
      'Highly selective vesicular monoamine transporter 2 (VMAT2) inhibitor that reduces presynaptic dopamine packaging into synaptic vesicles, decreasing dopaminergic neurotransmission in the basal ganglia to reduce involuntary movements',
    ...
    key_data:
      'KINECT 3 trial (NCT02274558): -3.2 AIMS score improvement vs -0.1 placebo (80mg; p<0.001); n=234. First FDA-approved treatment specifically for tardive dyskinesia. Blockbuster with >$2B annual revenue.',
    line_of_therapy: 'First-line',
    first_in_class: true,
    orphan_drug: false,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Tardive Dyskinesia',
    indication_specifics:
      'Treatment of tardive dyskinesia in adults; deuterated VMAT2 inhibitor with improved pharmacokinetics',
    mechanism:
      'Deuterated form of tetrabenazine that inhibits vesicular monoamine transporter 2 (VMAT2). Deuterium substitution slows CYP2D6 metabolism, providing more stable plasma levels and reduced dosing frequency vs tetrabenazine',
    mechanism_category: 'vmat2_inhibitor',
    molecular_target: 'Vesicular monoamine transporter 2 (VMAT2)',
    phase: 'Approved',
    primary_endpoint: 'AIMS (Abnormal Involuntary Movement Scale) total score change from baseline',
    key_data:
      "AIM-TD trial (NCT02291861): -3.0 AIMS score improvement (36mg) vs -1.4 placebo (p=0.019); n=298. Also approved for Huntington's chorea. Twice-daily dosing.",
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: false,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Tardive Dyskinesia',
    indication_specifics:
      'Selective NaV1.6 sodium channel inhibitor under investigation as a non-VMAT2 approach for tardive dyskinesia',
    mechanism:
      'Selective inhibitor of the NaV1.6 voltage-gated sodium channel subtype, which is preferentially expressed on excitatory neurons, reducing pathological hyperexcitability without broadly suppressing inhibitory neurotransmission',
    mechanism_category: 'sodium_channel_blocker',
    molecular_target: 'NaV1.6 voltage-gated sodium channel',
    phase: 'Phase 2',
    primary_endpoint: 'AIMS (Abnormal Involuntary Movement Scale) total score change from baseline',
    key_data:
      'Phase 2 proof-of-concept study evaluating NBI-921352 in tardive dyskinesia. Primary development focus is SCN8A epilepsy; TD represents indication expansion. Novel mechanism distinct from VMAT2 inhibitors.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Adjunctive treatment of seizures associated with Lennox-Gastaut syndrome in patients aged 1 year and older',
    mechanism:
      'Plant-derived cannabidiol (CBD) with multi-target anticonvulsant effects including GPR55 antagonism, TRPV1 desensitization, adenosine reuptake inhibition, and T-type calcium channel modulation',
    mechanism_category: 'cannabinoid',
    molecular_target: 'GPR55 / TRPV1 / adenosine transporter / multiple',
    phase: 'Approved',
    primary_endpoint:
      'Percent change from baseline in drop seizure (atonic, tonic, tonic-clonic) frequency per 28 days',
    key_data:
      'GWPCARE3 (NCT02224560): 44% median reduction in drop seizures (20mg/kg/day) vs 22% placebo (p=0.0135); n=225. GWPCARE4 confirmed: 42% reduction vs 17% placebo (p=0.0047); n=171.',
    line_of_therapy: 'Adjunctive',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Lennox-Gastaut Syndrome',
    indication_specifics:
      'Treatment of seizures associated with Lennox-Gastaut syndrome in patients aged 2 years and older',
    mechanism:
      'Serotonin-releasing agent and receptor agonist (5-HT1D, 5-HT2A, 5-HT2C) with sigma-1 receptor activity that reduces seizure susceptibility through modulation of serotonergic neurotransmission',
    mechanism_category: 'serotonin_modulator',
    ...
    key_data:
      'Study 1601 (NCT03355209): 26.5% median reduction in drop seizures (0.7 mg/kg/day) vs 7.6% placebo (p=0.0012); n=263. FDA approval for LGS in 2022, expanding beyond original Dravet indication.',
    line_of_therapy: 'Adjunctive',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Lennox-Gastaut Syndrome',
    indication_specifics:
      'Treatment of seizures associated with CDKL5 deficiency disorder and under investigation for broader developmental and epileptic encephalopathies including LGS',
    mechanism:
      'Synthetic neuroactive steroid (neurosteroid) that is a positive allosteric modulator of both synaptic and extrasynaptic GABA-A receptors, enhancing tonic and phasic GABAergic inhibition to reduce seizure susceptibility',
    ...
    key_data:
      'Marigold trial (NCT03572933) in CDKL5: 30.7% median reduction in major motor seizures vs 6.9% placebo (p=0.0036); n=101. FDA approved for CDKL5 deficiency disorder 2022. LGS evaluation ongoing.',
    line_of_therapy: 'Adjunctive',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'HDAC inhibitor for DMD targeting muscle inflammation and fibrosis; potential CNS benefits through HDAC-mediated epigenetic modulation in dystrophin-deficient brain',
    mechanism:
      'Pan-histone deacetylase (HDAC) inhibitor that modulates gene expression epigenetically, reducing muscle inflammation, fibrosis, and fatty infiltration. In the CNS, HDAC inhibition may improve synaptic plasticity and cognitive function in dystrophin-deficient neurons',
    ...
    key_data:
      'EPIDYS Phase 3 (NCT02851797): Met primary endpoint showing significant reduction in functional decline. First non-exon-skipping, non-gene therapy approach for DMD. FDA approved for DMD 2024 (Duvyzat).',
  ...
  },
  {
    ...
    indication: 'Duchenne Muscular Dystrophy - CNS Manifestations',
    indication_specifics:
      'Anti-CTGF antibody targeting connective tissue growth factor to reduce fibrosis in DMD; potential CNS effects through reduction of CTGF-mediated neuroinflammation',
    mechanism:
      'Fully human monoclonal antibody targeting connective tissue growth factor (CTGF/CCN2), blocking fibrotic signaling cascades (TGF-beta, Wnt, integrin pathways) that drive progressive muscle replacement with fibrotic tissue',
    ...
    key_data:
      'LELANTOS-2 Phase 3 trial (NCT04632940): Evaluating pamrevlumab in non-ambulatory DMD. Earlier Phase 2 showed trends toward slowed functional decline. CTGF is also expressed in brain, with potential neuroprotective effects.',
    line_of_therapy: 'Add-on therapy',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Duchenne Muscular Dystrophy - CNS Manifestations',
    indication_specifics:
      'Exon 45 skipping antisense oligonucleotide for DMD; restores truncated dystrophin production including brain-expressed isoforms',
    mechanism:
      'Phosphorodiamidate morpholino oligomer (PMO) that binds exon 45 of dystrophin pre-mRNA, inducing exon skipping to restore the reading frame and produce a truncated but partially functional dystrophin protein',
    ...
    key_data:
      'Accelerated FDA approval 2021 based on dystrophin production surrogate endpoint. ESSENCE trial (NCT02500381): Evaluating casimersen alongside golodirsen. Applicable to ~8% of DMD patients with exon 45-amenable mutations.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'First-line treatment for trigeminal neuralgia; voltage-gated sodium channel blocker reducing ectopic neuronal firing in the trigeminal nerve',
    mechanism:
      'Use-dependent voltage-gated sodium channel blocker (primarily NaV1.7 and NaV1.8) that stabilizes inactivated sodium channels, reducing high-frequency repetitive firing in damaged trigeminal nerve fibers',
    mechanism_category: 'sodium_channel_blocker',
    ...
    key_data:
      'Gold standard for trigeminal neuralgia for 60+ years. Initial response rate 70-90%. NNT (number needed to treat) of 1.7-1.8 for meaningful pain relief. Evidence from multiple controlled trials dating to 1960s.',
    line_of_therapy: 'First-line',
    first_in_class: false,
    orphan_drug: false,
    has_biomarker_selection: false,
  ...
  },
  {
    ...
    indication: 'Trigeminal Neuralgia',
    indication_specifics:
      'Second-line treatment for trigeminal neuralgia; keto-analog of carbamazepine with improved tolerability and fewer drug interactions',
    mechanism:
      'Voltage-gated sodium channel blocker that stabilizes hyperexcited neuronal membranes via its active metabolite (10-monohydroxy derivative, MHD). Blocks high-frequency repetitive firing with fewer CYP-mediated drug interactions than carbamazepine',
    mechanism_category: 'sodium_channel_blocker',
    ...
    key_data:
      'Multiple open-label and controlled studies supporting efficacy comparable to carbamazepine. Response rate 60-85% in trigeminal neuralgia. Often used when carbamazepine is not tolerated. Better drug interaction profile.',
  ...
  },
  {
    ...
    indication: 'Trigeminal Neuralgia',
    indication_specifics:
      'Selective NaV1.7 sodium channel blocker for trigeminal neuralgia with improved selectivity over carbamazepine',
    mechanism:
      'Selective state-dependent inhibitor of NaV1.7 voltage-gated sodium channel, preferentially blocking the channel in its inactivated state to reduce ectopic firing in nociceptive trigeminal neurons while minimizing effects on normal neuronal function',
    mechanism_category: 'sodium_channel_blocker',
    ...
    key_data:
      'Phase 3 CONVEY trial (NCT03637387): Evaluating vixotrigine vs placebo in classical trigeminal neuralgia. Phase 2a showed 30% reduction in paroxysm days vs placebo. NaV1.7 selectivity expected to improve tolerability.',
    line_of_therapy: 'First-line or second-line',
    first_in_class: true,
    orphan_drug: false,
    has_biomarker_selection: false,
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    indication_specifics:
      'Fixed-dose combination therapy (baclofen, naltrexone, sorbitol) for CMT1A targeting PMP22 overexpression',
    mechanism:
      'Synergistic fixed-dose combination of three repurposed drugs: baclofen (GABA-B agonist), naltrexone (opioid antagonist), and sorbitol (mTOR pathway modulator) that together reduce PMP22 gene overexpression, the cause of CMT1A',
    ...
    key_data:
      'PLEO-CMT Phase 3 (NCT02579759): Initial Phase 3 invalidated due to formulation stability issue. Reformulated PXT3003 in repeat Phase 3 (NCT04762758). Phase 2 showed dose-dependent improvement in ONLS and CMTNS. Most advanced therapy for CMT1A.',
    line_of_therapy: 'First-line (disease-modifying)',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  },
  {
    ...
    indication: 'Charcot-Marie-Tooth Disease',
    indication_specifics:
      'Antisense oligonucleotide designed to reduce PMP22 mRNA expression in Schwann cells for treatment of CMT1A',
    mechanism:
      'Antisense oligonucleotide (ASO) targeting PMP22 mRNA to reduce overexpression of peripheral myelin protein 22 in Schwann cells, addressing the gene dosage mechanism underlying CMT1A demyelinating neuropathy',
    mechanism_category: 'antisense_oligonucleotide',
    ...
    key_data:
      'Phase 1 first-in-human study initiated to evaluate safety and target engagement. Preclinical data in CMT1A rodent models showed reduction in PMP22 expression and improvement in myelination. Intrathecal or subcutaneous delivery under evaluation.',
    line_of_therapy: 'First-line (disease-modifying)',
    first_in_class: false,
    orphan_drug: true,
    has_biomarker_selection: true,
  ...
  },
  {
    ...
    indication: 'Charcot-Marie-Tooth Disease',
    indication_specifics:
      'Selective inhibitor of stress-induced phosphatase PPP1R15A (GADD34) to enhance the integrated stress response and improve protein folding in CMT1B',
    mechanism:
      'Selective inhibitor of the stress-induced regulatory subunit of protein phosphatase 1 (PPP1R15A/GADD34) that prolongs the integrated stress response (ISR), enhancing proteostasis and reducing accumulation of misfolded myelin protein zero (MPZ) in Schwann cells',
    ...
    key_data:
      'Phase 1 study evaluating oral IFB-088 (sephin1) in healthy volunteers and CMT1B patients. Strong preclinical data showing improved myelination, motor function, and nerve conduction in CMT1B mouse models. Oral daily dosing.',
    line_of_therapy: 'First-line (disease-modifying)',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
