...
export const RARE_DISEASE_COMPETITORS: CompetitorRecord[] = [
  ...
  {
    asset_name: 'AAV gene therapy (investigational)',
    company: 'Multiple (preclinical)',
    indication: 'Lysosomal Acid Lipase Deficiency',
    indication_specifics: 'AAV-based gene therapy to provide durable LAL enzyme expression — no specific IND-stage program identified as of Jan 2025',
  ...
  },
  {
    ...
    key_data: 'Early-stage development leveraging Amicus chaperone platform validated in Fabry and Pompe diseases — no LAL-D-specific clinical data disclosed as of Jan 2025',
    line_of_therapy: '1L',
    first_in_class: true,
    orphan_drug: true,
    has_biomarker_selection: true,
