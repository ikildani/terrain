...
export const LOA_BY_PHASE_AND_AREA: Record<string, Record<DevelopmentStage, number>> = {
  ...
  oncology:           { preclinical: 0.05, phase1: 0.07, phase2: 0.15, phase3: 0.40, approved: 1.0 },
  immunology:         { preclinical: 0.06, phase1: 0.09, phase2: 0.20, phase3: 0.54, approved: 1.0 },
  ...
  rare_disease:       { preclinical: 0.10, phase1: 0.16, phase2: 0.28, phase3: 0.66, approved: 1.0 },
  ...
  metabolic:          { preclinical: 0.06, phase1: 0.11, phase2: 0.22, phase3: 0.60, approved: 1.0 },
  infectious_disease: { preclinical: 0.05, phase1: 0.10, phase2: 0.21, phase3: 0.58, approved: 1.0 },
  hematology:         { preclinical: 0.07, phase1: 0.12, phase2: 0.22, phase3: 0.52, approved: 1.0 },
  ophthalmology:      { preclinical: 0.06, phase1: 0.10, phase2: 0.18, phase3: 0.50, approved: 1.0 },
  ...
  dermatology:        { preclinical: 0.06, phase1: 0.10, phase2: 0.22, phase3: 0.55, approved: 1.0 },
...
export const INDICATION_SPECIFIC_LOA: Record<string, Record<DevelopmentStage, number>> = {
  ...
  'pancreatic cancer':        { preclinical: 0.02, phase1: 0.03, phase2: 0.06, phase3: 0.20, approved: 1.0 },
  ...
  'renal cell carcinoma':     { preclinical: 0.05, phase1: 0.08, phase2: 0.16, phase3: 0.40, approved: 1.0 },
  'hepatocellular carcinoma': { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.30, approved: 1.0 },
  ...
  'cll':                      { preclinical: 0.06, phase1: 0.10, phase2: 0.20, phase3: 0.50, approved: 1.0 },
  'dlbcl':                    { preclinical: 0.05, phase1: 0.08, phase2: 0.18, phase3: 0.40, approved: 1.0 },
  'bladder cancer':           { preclinical: 0.04, phase1: 0.07, phase2: 0.14, phase3: 0.35, approved: 1.0 },
  'gastric cancer':           { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.28, approved: 1.0 },
  ...
  'alzheimer':                { preclinical: 0.02, phase1: 0.03, phase2: 0.06, phase3: 0.30, approved: 1.0 },
  "alzheimer's disease":      { preclinical: 0.02, phase1: 0.03, phase2: 0.06, phase3: 0.30, approved: 1.0 },
  'parkinson':                { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.40, approved: 1.0 },
  "parkinson's disease":      { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.40, approved: 1.0 },
  'multiple sclerosis':       { preclinical: 0.05, phase1: 0.08, phase2: 0.18, phase3: 0.55, approved: 1.0 },
  'epilepsy':                 { preclinical: 0.04, phase1: 0.07, phase2: 0.15, phase3: 0.50, approved: 1.0 },
  'migraine':                 { preclinical: 0.05, phase1: 0.08, phase2: 0.20, phase3: 0.58, approved: 1.0 },
  ...
  'huntington':               { preclinical: 0.02, phase1: 0.03, phase2: 0.05, phase3: 0.20, approved: 1.0 },

  // IMMUNOLOGY SUB-INDICATIONS
  'rheumatoid arthritis':     { preclinical: 0.07, phase1: 0.10, phase2: 0.22, phase3: 0.58, approved: 1.0 },
  'psoriasis':                { preclinical: 0.08, phase1: 0.12, phase2: 0.28, phase3: 0.65, approved: 1.0 },
  'atopic dermatitis':        { preclinical: 0.07, phase1: 0.11, phase2: 0.25, phase3: 0.60, approved: 1.0 },
  ...
  'lupus':                    { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.32, approved: 1.0 },

  // RARE DISEASE (high variability by specific condition)
  'sickle cell disease':      { preclinical: 0.10, phase1: 0.18, phase2: 0.30, phase3: 0.65, approved: 1.0 },
  'cystic fibrosis':          { preclinical: 0.12, phase1: 0.20, phase2: 0.35, phase3: 0.70, approved: 1.0 },
  'duchenne':                 { preclinical: 0.06, phase1: 0.10, phase2: 0.20, phase3: 0.50, approved: 1.0 },
  'hemophilia':               { preclinical: 0.10, phase1: 0.16, phase2: 0.28, phase3: 0.62, approved: 1.0 },
  'spinal muscular atrophy':  { preclinical: 0.10, phase1: 0.18, phase2: 0.32, phase3: 0.68, approved: 1.0 },

  // METABOLIC
  'type 2 diabetes':          { preclinical: 0.07, phase1: 0.12, phase2: 0.25, phase3: 0.65, approved: 1.0 },
  'obesity':                  { preclinical: 0.06, phase1: 0.10, phase2: 0.22, phase3: 0.58, approved: 1.0 },
  'nash':                     { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.35, approved: 1.0 },
  'mash':                     { preclinical: 0.03, phase1: 0.05, phase2: 0.10, phase3: 0.35, approved: 1.0 },
...
export const PHASE_TRANSITION_RATES: Record<string, { from: string; to: string; rate: number }[]> = {
  oncology: [
    ...
    { from: 'Phase 2', to: 'Phase 3', rate: 0.30 },
    { from: 'Phase 3', to: 'Approval', rate: 0.40 },
  ],
  immunology: [
  ...
  rare_disease: [
    { from: 'Phase 1', to: 'Phase 2', rate: 0.70 },
  ...
  metabolic: [
    ...
    { from: 'Phase 3', to: 'Approval', rate: 0.60 },
  ],
  cardiovascular: [
    { from: 'Phase 1', to: 'Phase 2', rate: 0.58 },
  ...
  hematology: [
    { from: 'Phase 1', to: 'Phase 2', rate: 0.60 },
  ...
  default: [
    { from: 'Phase 1', to: 'Phase 2', rate: 0.60 },
    { from: 'Phase 2', to: 'Phase 3', rate: 0.30 },
    { from: 'Phase 3', to: 'Approval', rate: 0.50 },
  ],
};
...
export function getLikelihoodOfApproval(
  therapyArea: string,
  ...
  return DEFAULT_LOA[stage] ?? 0.10;
}

export function getPhaseTransitionRates(
  therapyArea: string,
